...
const commonVariables = {
    ...
    ACTION_TYPE : ["TASK", "TASK_RATING", "PROJECTS","TEAM_MEMBER","GUEST"],
    ACTION_TAKEN : ["TASK_RATING", "TASK_STATUS_CHANGE","TASK_DUE_DATE_CHANGE","PROJECT_NAME_CHANGED", "PROJECT_CATEGORY_CHANGED", "TEAM_MEMBER_ADDED","GUEST_ADDED"],
